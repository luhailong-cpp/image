#!/usr/bin/env python3
"""Mechanical Q64 Tianyong r10_c09 4x4 native-patch assembly. No generation or source resizing."""
...
OUTPUT = ROOT / "output"
QA = ROOT / "qa"
ART = OUTPUT / "tianyong_r10_c09_q64_4k_candidate.png"
...
def assemble() -> dict:
    ...
    manifest = {
        ...
        "published": False,
        "scope": "One more-Q/chibi Tianyong festival r10_c09 4096-square candidate at 65536-square whole-city density, covering 18.75x18.75 world units, from 16 native1254 patches; not a complete city map.",
        "backendModelVerified": False,
        "backendModel": None,
