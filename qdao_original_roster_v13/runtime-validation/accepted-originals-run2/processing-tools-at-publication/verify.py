...
def verify(character,direction=None,require_visual=False):
 ...
 for key in keys:
  ...
  chroma_thresholds=rec.get('chroma_thresholds',[100,150]);require(chroma_thresholds in ([100,150],[50,75]),'Unsupported recorded chroma-key thresholds')
  keyed=keyer.remove_bg_magenta(prepared,*chroma_thresholds);alpha=np.asarray(keyed)[:,:,3]
