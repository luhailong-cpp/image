...
(async()=>{
const root='E:/work/image/qdao_original_roster_v13/candidate/03_lotus_healer_girl',out=path.join(root,'review/browser-final-candidate/detail');fs.mkdirSync(out,{recursive:true});
