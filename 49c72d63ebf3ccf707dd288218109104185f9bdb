# 揽仙镇春景 r08_c06–r08_c07 局部候选审核

选定版本：**pair-v5**。两块各4096×4096，共同8192×4096图先完成边界修补，再原样裁成相邻块。正式验收、整城完成、最近游戏镜头和客户端发布均为否。
...
春景pair y≈2278处，v3/v4固定拼接线曾造成多条砖缝横向截断，保留为失败历史；v5新增原生修补只贴地面中央带[3350,1980,4604,2600]，原尺寸查看四周回接后，已观察到的截断线消除。没有覆盖下方屋顶、叶簇或红色饰物。
