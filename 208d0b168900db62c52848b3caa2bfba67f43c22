...
import json,hashlib
root=Path(r'E:/work/image/qdao_city_tiles_4k_20260916/builtin_q64_production/lanxian_day/r08_c06')
base=root/'output/lanxian_day_r08_c06_q64_4k_candidate.png'
repair=root/'repairs/v2'
for d in ['guides','prompts','native']: (repair/d).mkdir(parents=True,exist_ok=True)
boxes={'paving':[1980,320,3234,1574],'roof_tone':[1430,2500,2684,3754]}
