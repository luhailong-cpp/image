...
2026-09-20 客户端准备目录：删除222张可恢复副本和14张旧截图，释放129.33 MiB；保留原图、脚本、清单和现行exact UI切片。[清理与恢复入口](../client_ui_refresh_20260908/cleanup-20260920.md)。

2026-09-20 追加精简：删除442张旧拼接与人物重复PNG，释放约2.29 GiB；当前PNG约22.42 GiB。[删除依据、验证与恢复](PNG_PROCESS_CLEANUP_20260920.md)。

2026-09-20 主城与人物专项清理：删除2,366张旧效果、历史导出与过程图，释放约1.07 GiB；[清理明细、保留范围与恢复方法](CITY_CHARACTER_CLEANUP_20260920.md)。

2026-09-19 追加检查：删除7个一次性Python、3个中间JSON、10张过程／重复图和5份临时文档，合计7.87 MiB；[明细与保留依据](CLEANUP_FOLLOWUP_20260919.md)。

2026-09-19 Python/JSON检查：删除10个一次性补丁脚本、33个失效批次清单，约378 KiB；[用途判断与清理明细](CODE_METADATA_CLEANUP_20260919.md)。

2026-09-19 已对整个 `E:/work/image` 清理，包括本地缓存和旧 ZIP：本轮释放 4.37 GiB，见[全目录清理记录](IMAGE_DIRECTORY_CLEANUP_20260919.md)。

2026-09-17 继续清理 Git 已追踪的过程图：2,154 张、829.42 MiB，详见[已追踪过程图清理](TRACKED_IMAGE_CLEANUP_20260917.md)。

最新清理：2026-09-16 删除 88 张重复处理图及 10 个 Git 临时垃圾文件，释放约 13.25 GiB，见[本次清理记录](STORAGE_CLEANUP_20260916.md)。以下方案核对与首次清理记录日期为 2026-09-12。
