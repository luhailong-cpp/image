"""Build byte-preserving 06 mixed action snapshots and explicitly unapproved previews."""
...
CHAR='06_thunder_caster_boy';DIRS=('N','NE','E','SE','S','SW','W','NW')
...
def main():
 ...
 (HERE/'index.html').write_text(f'<!doctype html><html lang="zh-CN"><meta charset="utf-8"><title>06 雷法少年素材预览</title><style>body{{font:20px system-ui;margin:40px;background:#eee9dc;color:#173833}}a{{color:#175d57}}</style><h1>06 雷法少年 · 八方向混合素材预览</h1><p>当前快照：{args.revision}。{manifest["actual_walk"]}/128 行走，{manifest["actual_idle"]}/8 独立站立。未正式批准，未接入客户端。</p><p><a href="revisions/{args.revision}/index.html">打开八方向逐帧／30ms循环预览</a></p><p><a href="revisions/{args.revision}/manifest.json">查看逐文件来源、尺寸与SHA</a></p></html>',encoding='utf-8')
