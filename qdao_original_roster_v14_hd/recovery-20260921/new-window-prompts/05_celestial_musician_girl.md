...
本角色接手快照：
已有旧52walk+8idle和12张HD补帧，合计64walk+8idle；尚缺SE/SW/W/NW各16张，共64walk。NE虽有16帧但未验收：NE03换腿相位错误、NE16→01高度跳变需返工，不能直接标通过。先读recovery-20260921/05-audit/NE-VISUAL-REVIEW.md，以及candidate/05_celestial_musician_girl/HANDOFF_20260919_PAUSED.md（路径均相对qdao_original_roster_v14_hd）。已有NE原图原生1254，处理固定scale .84、purple-preserve50/75；保护角色真实紫色服装与飘带。12张既有HD已做影子来源/像素重建，历史LF/CRLF差异不要篡改为新请求。

本机已核实原始肖像：
D:\luyuan\wuxingqitan\image\q_daoist_character_pack_4096\05_celestial_musician_girl_transparent_4096.png
