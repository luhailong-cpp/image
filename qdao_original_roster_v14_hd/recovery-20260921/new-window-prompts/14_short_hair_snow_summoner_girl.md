请恢复制作14_short_hair_snow_summoner_girl（唤雪少女）的角色移动图。
...
本角色接手快照：
现有快照未发现动作包，需制作128张行走及8张独立站立；开工前重新盘点。

本机已核实原始肖像：
D:\luyuan\wuxingqitan\image\q_daoist_character_pack_4096\14_short_hair_snow_summoner_girl_transparent_4096.png
