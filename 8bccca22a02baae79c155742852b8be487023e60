#!/usr/bin/env python3
"""Mechanical Q64 Donghai lantern same-geometry v2 r08_c08 4x4 native-patch assembly. No generation or source resizing."""
...
OUTPUT = ROOT / "output"
QA = ROOT / "qa"
ART = OUTPUT / "donghai_lantern_r08_c08_q64_4k_candidate.png"
...
def assemble() -> dict:
    ...
    manifest = {
        ...
        "published": False,
        "scope": "One more-Q/chibi Donghai lantern same-geometry v2 r08_c08 4096-square candidate at 65536-square whole-city density, covering 18.75x18.75 world units, from 16 native1254 patches; not a complete city map.",
        "backendModelVerified": False,
        "backendModel": None,
