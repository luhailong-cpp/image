...
def main():
    ...
    ref=TOP/"builtin_q64_all_city_references"/VARIANT/"map-native-layout-reference.png"
    ...
    if args.mode=="direct":
        g=im.transform((1254,1254),Image.Transform.EXTENT,box,resample=Image.Resampling.BICUBIC)
