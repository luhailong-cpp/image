...
2026-09-11 当前无字控件与头像以 [v10 重切说明](../../qdao_ui_style_recut_v10/README.md)和 [31 张属性切片](v2-painted/unity-slices/README.md)为准。遵循指定选角图的深玉绿、象牙米白、暖金与道家 Q 版节庆点缀；其他游戏图仅参考功能。当前交互入口已同步为 [v10 网页预览](v10-preview/README.md)，包含新版桌面／手机截图、22张正式切片副本和完整加点交互。下文根目录HTML及整屏主稿保留为历史版本。
