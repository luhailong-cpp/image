...
const placement = {
  ...
  scope: 'Visual HUD only. These are the three actions visible in movement_diagnostics/movement_full_window.png. No other screens, interaction logic, or action bindings are implemented.'
};
