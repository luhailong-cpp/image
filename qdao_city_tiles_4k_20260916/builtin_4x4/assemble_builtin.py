#!/usr/bin/env python3
"""Mechanical 4x4 native-patch assembly. No image generation or source changes."""
...
HELPERS = ROOT.parents[1] / "tianyong_festival_hd_20260910" / "seam_helpers.py"
GRID = 4
CORE = 1024
HALO = 115
OVERLAP = 2 * HALO
...
OUTPUT = ROOT / "output"
QA = ROOT / "qa"
ART = OUTPUT / "tianyong_plaza_4k_candidate.png"
...
def write_qa(image: Image.Image) -> list[dict]:
    ...
    crops = {
        "stair_left_100pct": (580, 0, 1480, 900),
        "stair_right_100pct": (1900, 0, 2800, 900),
        "center_taiji_100pct": (1598, 1598, 2498, 2498),
    }
...
def assemble() -> dict:
    ...
    manifest = {
        ...
        "published": False,
        "scope": "One Tianyong plaza 4096-square candidate from 16 independently generated native patches; not a complete city map.",
        "backendModelVerified": False,
        "backendModel": None,
        ...
        "qa": qa_items,
        "visualQa": {"status": "pending", "note": "Numeric seam differences are diagnostic only; geometry continuity, center symbol, stairs and all seam intersections require visual review."},
