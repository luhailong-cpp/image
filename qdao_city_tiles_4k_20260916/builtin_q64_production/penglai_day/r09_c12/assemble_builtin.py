#!/usr/bin/env python3
"""Mechanical Q64 penglai_day r09_c12 4x4 native-patch assembly. No generation or source resizing."""
...
OUTPUT = ROOT / "output"
QA = ROOT / "qa"
ART = OUTPUT / "penglai_day_r09_c12_4k_candidate.png"
...
def assemble() -> dict:
    ...
    manifest = {
        ...
        "published": False,
        "scope": "One Q/chibi penglai_day r09_c12 4096-square candidate at65536 city density,18.75x18.75world units,16 native1254 patches. External neighboring delivery tiles are unverified; not a complete city.",
        "backendModelVerified": False,
        "backendModel": None,
