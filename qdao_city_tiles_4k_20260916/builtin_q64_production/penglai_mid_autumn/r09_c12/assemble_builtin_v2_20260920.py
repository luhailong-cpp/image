#!/usr/bin/env python3
"""Mechanical Q64 penglai_mid_autumn r09_c12 4x4 native-patch assembly. No generation or source resizing."""
...
FINAL = GRID * CORE
OUTPUT = ROOT / "output_v2_20260920"
QA = ROOT / "qa_v2_20260920"
ART = OUTPUT / "penglai_mid_autumn_r09_c12_4k_candidate.png"
...
def write_qa(image: Image.Image) -> list[dict]:
    ...
    crops = {
        "railing_100pct": (2200, 800, 3100, 1700),
        "lantern_footing_100pct": (1300, 2800, 2200, 3700),
        "waterfront_100pct": (2800, 2800, 3700, 3700),
    }
...
def assemble() -> dict:
    ...
    if plan.get("guidePreparation", {}).get("status") not in ("ready_unified_style_reference", "ready_unified_local_structure"):
    ...
    manifest = {
        ...
        "published": False,
        "scope": "One Q/chibi penglai_mid_autumn r09_c12 4096-square candidate at65536 city density,18.75x18.75world units,16 native1254 patches. External neighboring delivery tiles are unverified; not a complete city.",
        "backendModelVerified": False,
        "backendModel": None,
        "requestedProduct": "ChatGPT Images 2.5",
