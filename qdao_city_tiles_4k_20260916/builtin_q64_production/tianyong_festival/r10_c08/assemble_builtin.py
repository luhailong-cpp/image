#!/usr/bin/env python3
"""Mechanical Q64 Tianyong r10_c08 4x4 native-patch assembly. No generation or source resizing."""
...
OUTPUT = ROOT / "output"
QA = ROOT / "qa"
ART = OUTPUT / "tianyong_r10_c08_q64_4k_candidate.png"
...
def write_qa(image: Image.Image) -> list[dict]:
    ...
    crops = {
        "tree_upper_left_100pct": (350, 300, 1250, 1200),
        "garden_lower_left_100pct": (500, 2800, 1400, 3700),
        "garden_stairs_lower_right_100pct": (2800, 2800, 3700, 3700),
    }
...
def assemble() -> dict:
    ...
    manifest = {
        ...
        "published": False,
        "scope": "One more-Q/chibi Tianyong festival r10_c08 4096-square candidate at 65536-square whole-city density, covering 18.75x18.75 world units, from 16 native1254 patches; not a complete city map.",
        "backendModelVerified": False,
        "backendModel": None,
