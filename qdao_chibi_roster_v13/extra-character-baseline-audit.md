...
调查时间：2026-09-17T07:14:04.471622+00:00。此报告为素材与代码静态调查，不代表本次 V13 已制作、已接入或运行验收通过。
...
四帧manifest真实SHA-256：`d815d5ee2ac9e735ba8da83a7af0f8c4fd668cd6785c264bd6711bacb99053c0`。32个源PNG全部与manifest记录SHA一致：`True`。
...
吕洞宾V12冻结manifest核验通过：`3dbc699023fd7fe6f45304fd91ecea2f088e107d4c727d375dc1b23c31e68c68` 与任务及 completion-20260916.json 相同。调查开始时，image内无既有qdao_chibi_roster_v13目录，正式客户端Characters内仅QdaoHeadbandBoy/QdaoRosterV11/QdaoRosterV12，未发现已发布V13。随后当前主任务建立V13/tools，为本轮在途工作。

## 对比联系图与处理边界

联系图上排为现用idle及8个完整512格，下排为用户指定4帧及身份参考。各完整正方形画布统一显示为144px，没有按人物bbox重缩放，不做新动作、不修改源图和正式游戏资源。

- [baseline-S-E.jpg](extra-character-baseline-review/baseline-S-E.jpg)
- [baseline-N-W.jpg](extra-character-baseline-review/baseline-N-W.jpg)
- [baseline-NE-SW.jpg](extra-character-baseline-review/baseline-NE-SW.jpg)
- [baseline-NW-SE.jpg](extra-character-baseline-review/baseline-NW-SE.jpg)
...
四张联系图、八个方向已逐张查看，人物完整格和标签均可见。两套基线的造型差异明显：指定四帧造型头更大、身体更短，正面金葫芦位于上身侧；现用八帧更瘦长、葫芦垂至腰侧，东西方向为较大跨步跑态。因此基线选择影响既有形象及动作风格，不能只当作帧数选择。当前图仅支持基线审阅，不是本轮16帧动画验收。
