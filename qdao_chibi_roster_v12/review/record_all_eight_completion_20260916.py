...
EVIDENCE=PROJECT/'Docs/ArtEvidence/v12-stable-roster/eight-natural-current-code-20260916'
...
for cid in IDS:
 ...
 check=verify_character(p,True);assert check['status']=='passed'
