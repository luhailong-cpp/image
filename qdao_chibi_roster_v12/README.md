...
运行时准备方案见 CLIENT_CONTRACT.md。处理工具和运行时代码已准备；当前已发布24吕洞宾、29何仙姑、30韩湘子的完整V12资源；其余五位仍在制作和验收。
...
2026-09-13：24吕洞宾、29何仙姑、30韩湘子已分别完整通过89媒体校验并接入Unity，各自64走路+8独立站立+肖像。最新三位同时启用V12的Unity检查为121/121 EditMode与7/7 PlayMode通过，覆盖资源选择、全部角色八方向逐帧播放、停步、独立外观缓存与真实天墉城控制器。证据位于E:/work/mmorpg-client/Docs/ArtEvidence/v12-three-immortals，包含实际游戏截图及带版本/帧数的运行记录。后续角色升级后继续针对最终资源验证。
