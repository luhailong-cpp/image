...
namespace MmorpgClient.Tests.EditMode.Tianyong
{
    ...
    public sealed class TianyongClickMarkerTests
    {
        ...
        {
            foreach (var marker in Object.FindObjectsByType<TianyongClickMarker>(FindObjectsInactive.Include, FindObjectsSortMode.None))
            {
        ...
        public void Spawn_FiveTimes_KeepsAtMostTwoAlive()
        {
            ...
            var inScene = Object.FindObjectsByType<TianyongClickMarker>(FindObjectsInactive.Include, FindObjectsSortMode.None);
