...
namespace MmorpgClient.World.Tianyong
{
    ...
    public sealed class TianyongSandboxAutoDrive : MonoBehaviour
    {
        ...
        private IEnumerator CoRun()
        {
            ...
            // A stray mouse click while the player window takes focus would
            // walk the actor off an observation point and make the captured
            // frames non-reproducible; the drive owns movement from here.
            _ctrl.SetIgnoreMouseInput(true);
        ...
        private void Click(Vector3 groundPoint, string why)
        {
            ...
            Log($"click {why} at={F(groundPoint)} routed={ok} feet={F(_ctrl.FeetPosition)}");
        }
        ...
        private void Finish(int code)
        {
            ...
            {
                _ctrl.SetDebugDirection(Vector3.zero);
                _ctrl.SetIgnoreMouseInput(false);
            }
